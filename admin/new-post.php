	...
	<div class="container topspace">
		<div class="form-wrapper">
			<form class="" method="post" action="<?php $PHP_SELF ?>">
				<h1 class="form-signin-heading">New Post</h1>
				
				<div class="space">
					<label for="postTitle"><h2>Post Title</h2></label>
					<input type="text" name="postTitle" placeholder="Post Title" class="form-control" required autofocus>
				</div>
				
				<div class="space">
					<label for="description"><h2>Post Description</h2></label>
				...
				<div class="space">
					<label for="content"><h2>Post Content</h2></label>
